...
export const initiatePayout = async (req, res) => {
    try {
        ...
        payoutInitiatedEmail(seller, auction, payout).catch((error) =>
...
export const completePayout = async (req, res) => {
    try {
        ...
        // Send email notification to seller
        payoutCompletedEmail(payout.seller, payout.auction, payout).catch((error) =>
...
export const failPayout = async (req, res) => {
    try {
        ...
        // Send email notification to seller
        payoutFailedEmail(payout.seller, payout).catch((error) =>
